...
export class AlldetailsComponent implements OnInit {
  ...
  dp2026EBSkuCols = [
    ...
    { field: 'DP2026EBKIDS3DAYS', headerName: 'All 3 Days — Child (0-5)' }
  ];
  ...
  dp2026REGSkuCols = [
    ...
    { field: 'DP2026REGKIDS3DAYS', headerName: 'All 3 Days — Child (0-5)' },
    ...
    { field: 'DP2026REGKIDSSAT', headerName: 'Saturday — Child (0-5)' },
    ...
    { field: 'DP2026REGKIDSSUN', headerName: 'Sunday — Child (0-5)' }
  ];
  ...
  dp2026NOCULSkuCols = [
    ...
    { field: 'DP2026NOCULKIDS3DAYS', headerName: 'All 3 Days — Child (0-5)' },
    ...
    { field: 'DP2026NOCULKIDSSAT', headerName: 'Saturday — Child (0-5)' },
    ...
    { field: 'DP2026NOCULKIDSSUN', headerName: 'Sunday — Child (0-5)' }
  ];

  dp2026CULSkuCols = [
    { field: 'DP2026CULTURALADULTSATSUNNONVEG', headerName: 'Sat & Sun — Adult (18+) - Non-Veg' },
    { field: 'DP2026CULTURALADULTSATSUNVEG', headerName: 'Sat & Sun — Adult (18+) - Veg' },
    { field: 'DP2026CULTURALYOUTHSATSUNNONVEG', headerName: 'Sat & Sun — Youth (6-17 yrs) - Adult Food - Non-Veg' },
    { field: 'DP2026CULTURALYOUTHSATSUNVEG', headerName: 'Sat & Sun — Youth (6-17 yrs) - Adult Food - Veg' },
    { field: 'DP2026CULTURALYOUTHWKIDSSATSUN', headerName: 'Sat & Sun — Youth (6-17 yrs) - Kids Food' },
    { field: 'DP2026CULTURALSTUDENTVPSATSUNNONVEG', headerName: 'Sat & Sun — Student / Visiting Parent - Non-Veg' },
    { field: 'DP2026CULTURALSTUDENTVPSATSUNVEG', headerName: 'Sat & Sun — Student / Visiting Parent - Veg' },
    { field: 'DP2026CULTURALKIDSSATSUN', headerName: 'Sat & Sun — Child (0-5)' },
    { field: 'DP2026CULTURALADULTSATNONVEG', headerName: 'Saturday — Adult (18+) - Non-Veg' },
    { field: 'DP2026CULTURALADULTSATVEG', headerName: 'Saturday — Adult (18+) - Veg' },
    { field: 'DP2026CULTURALYOUTHSATNONVEG', headerName: 'Saturday — Youth (6-17 yrs) - Adult Food - Non-Veg' },
    { field: 'DP2026CULTURALYOUTHSATVEG', headerName: 'Saturday — Youth (6-17 yrs) - Adult Food - Veg' },
    { field: 'DP2026CULTURALYOUTHWKIDSSAT', headerName: 'Saturday — Youth (6-17 yrs) - Kids Food' },
    { field: 'DP2026CULTURALSTUDENTVPSATNONVEG', headerName: 'Saturday — Student / Visiting Parent - Non-Veg' },
    { field: 'DP2026CULTURALSTUDENTVPSATVEG', headerName: 'Saturday — Student / Visiting Parent - Veg' },
    { field: 'DP2026CULTURALKIDSSAT', headerName: 'Saturday — Child (0-5)' },
    { field: 'DP2026CULTURALADULTSUNNONVEG', headerName: 'Sunday — Adult (18+) - Non-Veg' },
    { field: 'DP2026CULTURALADULTSUNVEG', headerName: 'Sunday — Adult (18+) - Veg' },
    { field: 'DP2026CULTURALYOUTHSUNNONVEG', headerName: 'Sunday — Youth (6-17 yrs) - Adult Food - Non-Veg' },
    { field: 'DP2026CULTURALYOUTHSUNVEG', headerName: 'Sunday — Youth (6-17 yrs) - Adult Food - Veg' },
    { field: 'DP2026CULTURALYOUTHWKIDSSUN', headerName: 'Sunday — Youth (6-17 yrs) - Kids Food' },
    { field: 'DP2026CULTURALSTUDENTVPSUNNONVEG', headerName: 'Sunday — Student / Visiting Parent - Non-Veg' },
    { field: 'DP2026CULTURALSTUDENTVPSUNVEG', headerName: 'Sunday — Student / Visiting Parent - Veg' },
  ...
  dp2026FullRows = [
    ...
    { label: 'All 3 Days — Child (0-5)', skus: ['DP2026EBKIDS3DAYS', 'DP2026REGKIDS3DAYS'] },
    ...
    { label: 'Saturday — Child (0-5)', skus: ['DP2026REGKIDSSAT'] },
    ...
    { label: 'Sunday — Child (0-5)', skus: ['DP2026REGKIDSSUN'] }
  ];
  ...
  dp2026NoCulRows = [
    ...
    { label: 'All 3 Days — Child (0-5)', skus: ['DP2026NOCULKIDS3DAYS'] },
    ...
    { label: 'Saturday — Child (0-5)', skus: ['DP2026NOCULKIDSSAT'] },
    ...
    { label: 'Sunday — Child (0-5)', skus: ['DP2026NOCULKIDSSUN'] }
  ];

  dp2026CulturalRows = [
    { label: 'Sat & Sun — Adult (18+) - Non-Veg', skus: ['DP2026CULTURALADULTSATSUNNONVEG'] },
    { label: 'Sat & Sun — Adult (18+) - Veg', skus: ['DP2026CULTURALADULTSATSUNVEG'] },
    { label: 'Sat & Sun — Youth (6-17 yrs) - Adult Food - Non-Veg', skus: ['DP2026CULTURALYOUTHSATSUNNONVEG'] },
    { label: 'Sat & Sun — Youth (6-17 yrs) - Adult Food - Veg', skus: ['DP2026CULTURALYOUTHSATSUNVEG'] },
    { label: 'Sat & Sun — Youth (6-17 yrs) - Kids Food', skus: ['DP2026CULTURALYOUTHWKIDSSATSUN'] },
    { label: 'Sat & Sun — Student / Visiting Parent - Non-Veg', skus: ['DP2026CULTURALSTUDENTVPSATSUNNONVEG'] },
    { label: 'Sat & Sun — Student / Visiting Parent - Veg', skus: ['DP2026CULTURALSTUDENTVPSATSUNVEG'] },
    { label: 'Sat & Sun — Child (0-5)', skus: ['DP2026CULTURALKIDSSATSUN'] },
    { label: 'Saturday — Adult (18+) - Non-Veg', skus: ['DP2026CULTURALADULTSATNONVEG'] },
    { label: 'Saturday — Adult (18+) - Veg', skus: ['DP2026CULTURALADULTSATVEG'] },
    { label: 'Saturday — Youth (6-17 yrs) - Adult Food - Non-Veg', skus: ['DP2026CULTURALYOUTHSATNONVEG'] },
    { label: 'Saturday — Youth (6-17 yrs) - Adult Food - Veg', skus: ['DP2026CULTURALYOUTHSATVEG'] },
    { label: 'Saturday — Youth (6-17 yrs) - Kids Food', skus: ['DP2026CULTURALYOUTHWKIDSSAT'] },
    { label: 'Saturday — Student / Visiting Parent - Non-Veg', skus: ['DP2026CULTURALSTUDENTVPSATNONVEG'] },
    { label: 'Saturday — Student / Visiting Parent - Veg', skus: ['DP2026CULTURALSTUDENTVPSATVEG'] },
    { label: 'Saturday — Child (0-5)', skus: ['DP2026CULTURALKIDSSAT'] },
    { label: 'Sunday — Adult (18+) - Non-Veg', skus: ['DP2026CULTURALADULTSUNNONVEG'] },
    { label: 'Sunday — Adult (18+) - Veg', skus: ['DP2026CULTURALADULTSUNVEG'] },
    { label: 'Sunday — Youth (6-17 yrs) - Adult Food - Non-Veg', skus: ['DP2026CULTURALYOUTHSUNNONVEG'] },
    { label: 'Sunday — Youth (6-17 yrs) - Adult Food - Veg', skus: ['DP2026CULTURALYOUTHSUNVEG'] },
    { label: 'Sunday — Youth (6-17 yrs) - Kids Food', skus: ['DP2026CULTURALYOUTHWKIDSSUN'] },
    { label: 'Sunday — Student / Visiting Parent - Non-Veg', skus: ['DP2026CULTURALSTUDENTVPSUNNONVEG'] },
    { label: 'Sunday — Student / Visiting Parent - Veg', skus: ['DP2026CULTURALSTUDENTVPSUNVEG'] },
