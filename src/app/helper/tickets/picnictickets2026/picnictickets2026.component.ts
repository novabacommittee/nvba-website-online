...
@Component({
  selector: 'app-picnictickets2026',
  templateUrl: './picnictickets2026.component.html',
  styleUrls: ['./picnictickets2026.component.scss']
})

export class Picnictickets2026Component implements OnInit, OnChanges, AfterViewChecked {
